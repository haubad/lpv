...
var HTMLemail = '<li class="flex-item"><span class="blue-text">mail</span><span class="white-text">%data%</span></li>';
...
var HTMLlocation = '<li class="flex-item"><span class="blue-text">ville</span><span class="white-text">%data%</span></li>';

var HTMLbioPic = '<img src="%data%" class="biopic">';
var HTMLWelcomeMsg = '<span class="welcome-message">%data%</span>';

var HTMLskillsStart = '<h3 id="skillsH3">Compétences fortes:</h3><ul id="skills"></ul>';
